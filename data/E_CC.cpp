...
///// Scalars /////
    ...
    scalars_["1"]  = 1.00 * dot(eri["oovv"]("j,i,b,a") * t1("a,i"), t1("b,j"));
    scalars_["2"]  = 1.00 * dot(eri["oovv"]("i,j,a,b"), t2("a,b,j,i"));
    scalars_["3"]  = 1.00 * dot(Id["oo"]("i,j") * eri["oooo"]("k,i,l,j"), Id["oo"]("k,l"));
    scalars_["4"]  = 1.00 * dot(f["ov"]("i,a"), t1("a,i"));
    scalars_["5"]  = 1.00 * dot(Id["oo"]("i,j"), f["oo"]("i,j"));
    scalars_["6"]  = -2.00 * scalars_["1"];
    scalars_["6"] -= 4.00 * scalars_["4"];
    scalars_["6"] -= 4.00 * scalars_["5"];
    scalars_["6"] += scalars_["2"];
    scalars_["6"] += 2.00 * scalars_["3"];
...
/////////////////// Evaluate Equations ///////////////////
    ...
    // E_CC  = +0.250 <j,i||a,b> t2(a,b,j,i) 
    //      += +1.00 f(i,i) 
    //      += +1.00 f(i,a) t1(a,i) 
    //      += -0.50 <j,i||j,i> 
    //      += -0.50 <j,i||a,b> t1(a,i) t1(b,j) 
    E_CC  = -0.250 * scalars_["6"];
